...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Ballast — Automated Capital Control" },
      {
        name: "description",
        content:
          "Ballast automates capital allocation and risk control so balance sheets stay steady in volatile markets.",
      },
      { name: "author", content: "Ballast" },
